...
- ตอบเป็นภาษาไทย กระชับและแม่นยำ แบ่งหัวข้อชัดเจน ขึ้นบรรทัดใหม่ทุกหัวข้อ ใส่อีโมจิหน้าหัวข้อให้เข้ากับเนื้อหา (ใช้ ⚠️ หรือ 🔻 กับหัวข้อที่ผลไม่ดี ไม่ต้องฝืนใช้อีโมจิบวกกับเรื่องลบ)
- แต่ละหัวข้อยาวไม่เกิน 2 ประโยค ห้ามเขียนพารากราฟยาว ห้ามเขียนข้อมูลจรทำมุมต่างๆ ใส่รายละเอียดไปเลย
