...
- ตีความจากข้อมูล aspect จริงที่ให้เท่านั้น เชื่อมโยงความหมายเชิงโหราศาสตร์ ต้องตรงกับข้อมูลที่ให้เป๊ะ
...
- ตอบเป็นภาษาไทย/ภาษาอังกฤษทับศัพท์ กระชับ แบ่งหัวข้อชัดเจน ขึ้นบรรทัดใหม่ทุกหัวข้อ ใส่อีโมจิหน้าหัวข้อให้เข้ากับเนื้อหา (ใช้ ⚠️ หรือ 🔻 กับหัวข้อที่ผลไม่ดี ไม่ต้องฝืนใช้อีโมจิบวกกับเรื่องลบ)
